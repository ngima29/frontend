...
const useNavigation = () => {
  ...
  const links = [
    ...
    { name: 'Earnings', href: '/earning', current: isCurrent('/earning'), icon: <IconCirclePlus className="mr-3.5" color={isCurrent('/earning') ? '#e6ecf3' : '#8aa6c8'} size={24} /> },
    ...
    { name: 'Transaction', href: '/transaction', current: isCurrent('/transaction'), icon: <IconCoinRupee color={isCurrent('/transaction') ? '#e6ecf3' : '#8aa6c8'} className="mr-3.5" size={22} /> },
    ...
    { name: 'Target', href: '/target', current: isCurrent('/target'), icon: <IconTargetArrow className="mr-3.5" color={isCurrent('/target') ? '#e6ecf3' : '#8aa6c8'} size={24} />},
